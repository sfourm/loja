...
$query = $pdo->query("SELECT * FROM prod_combos where id_combo = '" . $id_combo . "' ");
 ...
 $res = $query->fetchAll(PDO::FETCH_ASSOC);
      ...
      echo "<span class='text-dark mr-1'><small>".@$nome_prod."</small></span><a href='#' onClick='deletarProd(". @$res[$i]['id'] .")' title='Excluir Produto'><small><i class='text-danger far fa-trash-alt'></i></small></a>
                   <hr/>";
